...
import {
  ...
  hostListDirectoryRequestSchema, hostListRootsRequestSchema, hostOpenPathRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.listRoots': { schema: hostListRootsRequestSchema, invoke: (api, r, signal) => api.host.listRoots(r, signal) },
