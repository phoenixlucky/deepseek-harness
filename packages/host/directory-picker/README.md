...
- **No multi-root support** — the browse contract exposes one ancestry chain per listing; per-deployment root scoping waits for a consumer that needs it, per the DirectoryPicker Agent Note.
